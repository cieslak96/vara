        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10 text-sm">
          ...
          <div className="space-y-2">
            ...
            <ul className="space-y-1">
              ...
              <li><a href="/content" className="hover:underline">Content Policy</a></li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <a href="/careers" className="hover:underline block">Work With Us</a>
            </div>
            <div className="flex space-x-2 mt-4">
              <a href="https://www.instagram.com/vara_salon_suites/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="hover:opacity-75">
              ...
              <a href="https://www.linkedin.com/company/vara-salon-suites/people/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="hover:opacity-75">
                <svg className="w-7 h-7 fill-white " viewBox="-2 -2 24 24">
              ...
              <a href="https://www.facebook.com/varasalonsuites/" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="hover:opacity-75">
                <svg className="w-7 h-7 fill-white " viewBox="-2 -2 24 24">
