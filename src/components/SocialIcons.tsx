      ...
      >
        ...
        >
          ...
          <path
            ...
            className="fill-white group-hover:fill-white transition-colors duration-300"
          />
          <path
      ...
      >
        ...
        >
          ...
          <path
            ...
            className="stroke-white group-hover:stroke-white transition-colors duration-300"
            strokeWidth="2"
            strokeLinecap="round"
