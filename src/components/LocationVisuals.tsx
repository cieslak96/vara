...
export default function LaytonSection() {
  ...
  return (
    <section className="flex flex-col h-full gap-y-4">
      {/* Row 1: Facade */}
      <div className="relative w-full aspect-[1/1] lg:aspect-[7/6]  ">
        <Image
      ...
      {/* Row 2: Gallery */}
      <div
        className="relative w-full aspect-[1/1] lg:aspect-[7/6]  cursor-pointer"
      ...
      {/* Row 3: Video */}
      <div
        className="relative w-full aspect-[1/1] lg:aspect-[7/6]  cursor-pointer overflow-hidden"
