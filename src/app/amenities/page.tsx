        ...
        <section className="px-6 py-16 bg-white">
          <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-10">
            <div className="lg:w-1/2 space-y-4">
              ...
              <p>
                As always, we will be doing giveaways for VARA tenants the first Wednesday of every month. NO likes, subscription, or re-posting necessary. Just be a VARA tenant! We will randomly be selecting several tenants each week from across all our locations.
              </p>
              <p>
