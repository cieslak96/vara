    ...
    <>
      ...
      <main className="pt-32">
        ...
        <div className="flex w-full min-h-screen">
          ...
          {/* Form Section */}
          <div className="w-2/4 bg-[#f9f9f6] text-[#1e1e1e] px-10 py-20 flex flex-col justify-start">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="flex gap-4">
                <input
                  ...
                  className="w-1/2 border px-4 py-2 bg-neutral-50 border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring focus:border-black"
                />
                <input
                  name="lastName"
                  value={form.lastName}
